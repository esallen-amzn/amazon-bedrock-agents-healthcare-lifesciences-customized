#!/usr/bin/env python3
"""
Test the Instrument Diagnosis Assistant with a sample log file using the working format
"""
...
def test_agent_with_log_file():
    ...
    # Create the prompt with file content (same format as Streamlit app)
...
"""
    ...
    # Generate session ID (33+ characters as required)
    ...
    try:
        ...
        # Use the same format as our working test_simple.py
        cmd = f'agentcore invoke --session-id {session_id} \'{{"prompt": "Please analyze this log file and provide diagnosis recommendations. {log_content[:500]}..."}}\''
...
if __name__ == "__main__":
    print("🧪 Testing Instrument Diagnosis Assistant with Log File Analysis...")
